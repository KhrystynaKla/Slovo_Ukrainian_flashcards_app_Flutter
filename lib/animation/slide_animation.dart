...
class SlideAnimation extends StatefulWidget {
  const SlideAnimation({required this.child, required this.direction, this.animate=true, this.reset, this.animationCompleted, this.animationDuration = kSlideAwayDuration, this.animationDelay = 0,
